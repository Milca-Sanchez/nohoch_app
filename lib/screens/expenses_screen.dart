...
class ExpensesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final appBarBg = isDark ? const Color(0xFF0F172A) : Colors.red.shade50;
      ...
      body: treasury.isLoading
          ...
          : Padding(
              ...
              child: Column(
                ...
                children: [
                  Card(
                    color: isDark ? const Color(0xFF4C2222) : Colors.red.shade100,
                    elevation: 0,
                    child: Padding(
                      padding: const EdgeInsets.all(24.0),
                      child: Column(
                  ...
                  Expanded(
                    child: treasury.expenses.isEmpty
                        ? Center(
                            child: Column(
                            ...
                            builder: (context, constraints) {
                              ...
                              if (isLargeScreen) {
                                return GridView.builder(
                                  ...
                                  itemCount: treasury.expenses.length,
                                  itemBuilder: (context, index) {
                                    final expense = treasury.expenses[index];
                                    return _buildFinanceCard(context, expense, theme, currencyFormat, dateFormat);
                                  },
                                );
                              } else {
        ...
        builder: (context, setState) => AlertDialog(
          ...
          title: const Row(
            children: [
              ...
              SizedBox(width: 8),
              Text('Registrar Egreso', style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
          content: SizedBox(
            width: 500,
  ...
  void _showEditExpenseDialog(BuildContext context, TreasuryRecord record) {
    final formKey = GlobalKey<FormState>();
        ...
        builder: (context, setState) => AlertDialog(
          ...
          title: const Row(
            children: [
              ...
              SizedBox(width: 8),
              Text('Editar Egreso', style: TextStyle(fontWeight: FontWeight.bold)),
            ],
          ),
          content: SizedBox(
            width: 500,
              ...
              Row(
                ...
                children: [
                  ...
                  PopupMenuButton<String>(
                    ...
                    onSelected: (value) {
                      if (value == 'edit') {
                        _showEditExpenseDialog(context, record);
  ...
  void _showDeleteConfirmationDialog(BuildContext context, TreasuryRecord record) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text('¿Está seguro de que desea eliminar el registro de egreso "${record.concept}"? Esta acción no se puede deshacer.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.pop(context),
            child: const Text('Cancelar', style: TextStyle(fontWeight: FontWeight.bold)),
